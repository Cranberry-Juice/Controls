...
#ifndef struct_d_arduinodriver_ArduinoDigitalI
#define struct_d_arduinodriver_ArduinoDigitalI

struct d_arduinodriver_ArduinoDigitalI
{
  int16_T __dummy;
};

#endif                                // struct_d_arduinodriver_ArduinoDigitalI

#ifndef struct_codertarget_arduinobase_blocks_
#define struct_codertarget_arduinobase_blocks_

struct codertarget_arduinobase_blocks_
{
...
#endif                                // struct_codertarget_arduinobase_blocks_

// Custom Type definition for MATLABSystem: '<Root>/BNO055 IMU Sensor'
#include "MW_SVD.h"
#ifndef struct_c_arduinodriver_ArduinoI2C
#define struct_c_arduinodriver_ArduinoI2C

struct c_arduinodriver_ArduinoI2C
{
  MW_Handle_Type MW_I2C_HANDLE;
};

#endif                                 // struct_c_arduinodriver_ArduinoI2C

#ifndef struct_i_codertarget_arduinobase_inter
#define struct_i_codertarget_arduinobase_inter

struct i_codertarget_arduinobase_inter
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
...
#endif                                // struct_i_codertarget_arduinobase_inter

#ifndef struct_codertarget_arduinobase_interna
#define struct_codertarget_arduinobase_interna

struct codertarget_arduinobase_interna
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                // struct_codertarget_arduinobase_interna

#ifndef struct_codertarget_arduinobase_inter_o
#define struct_codertarget_arduinobase_inter_o

struct codertarget_arduinobase_inter_o
{
  int32_T isInitialized;
};

#endif                                // struct_codertarget_arduinobase_inter_o
...
extern "C" {
  ...
  // Class declaration for model KcontrolDeploy
  class KcontrolDeployModelClass
{
 ...
 public:
  ...
  // Copy Constructor
  KcontrolDeployModelClass(KcontrolDeployModelClass const&) =delete;

  // Assignment Operator
  KcontrolDeployModelClass& operator= (KcontrolDeployModelClass const&) & =
    delete;

  // Real-Time Model get method
  KcontrolDeployModelClass::RT_MODEL * getRTM();
 ...
 private:
  ...
  void SystemCore_setup(codertarget_arduinobase_interna *obj);
